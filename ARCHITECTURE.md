...
`skills` is a monorepo of [Claude Code](https://code.claude.com) skill plugins for everyday software-engineering workflows. It bundles 12 independent plugins — `code-review`, `review-me`, `bug-hunt`, `doc-skill`, `git-skill`, `handoff`, `long-task`, `build-reinstall`, `work-summary`, `plan-summary`, `human-friendly-writing`, and `skill-forge` — that together expose 28 canonical workflows through 29 installable Codex selectors.
