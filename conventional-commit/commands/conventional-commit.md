---
description: Split working-tree changes into Conventional Commits (one per logical unit). Variants — :push (then git push), :rewrite (rewrite recent non-Conventional commit subjects)
---
