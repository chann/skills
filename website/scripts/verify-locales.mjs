...
if (canonicalIds.length !== 28 || new Set(canonicalIds).size !== 28) {
  throw new Error(`Expected 28 unique canonical skill IDs, found ${canonicalIds.length}.`);
}
...
for (const locale of requiredLocales) {
  ...
  if (localizedIds.length !== 28 || missing.length || extra.length) {
    throw new Error(
