...
if (canonicalIds.length !== 29 || new Set(canonicalIds).size !== 29) {
  throw new Error(`Expected 29 unique canonical skill IDs, found ${canonicalIds.length}.`);
}
...
for (const locale of requiredLocales) {
  ...
  if (localizedIds.length !== 29 || missing.length || extra.length) {
    throw new Error(
