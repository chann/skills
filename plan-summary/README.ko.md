...
세 스킬 모두 자연스러운 한국어를 쓰는 기본 규칙을 포함합니다.
`human-friendly-writing`이 이미 있으면 검증 전에 문장만 한 번 더 다듬지만,
해당 스킬을 설치하거나 요구하지 않습니다.
...
한국어는 군더더기 없이 구체적으로 쓰며, 선택적 윤문 뒤에도 두 언어의 내용과
결과 파일을 다시 검증합니다.
